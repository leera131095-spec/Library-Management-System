...
function StatCard({ title, value, icon, color, bgColor }: StatCardProps) {
  return (
    <div className="bg-card rounded-xl p-6 fairytale-shadow border border-border/30 flex items-start gap-4">
      <div
        className={cn(
      ...
      <div>
        ...
        <p className="text-2xl font-bold text-foreground mt-1 font-serif">
          {value}
        </p>
      </div>
    </div>
    ...
    <div className="flex flex-col gap-8">
      ...
      <div className="bg-card rounded-xl p-6 fairytale-shadow border border-border/30">
        <div className="flex items-center gap-3 mb-1">
          <div className="w-10 h-10 rounded-lg bg-peach/40 flex items-center justify-center">
