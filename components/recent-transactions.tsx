  ...
  return (
    <div className="bg-card rounded-[--radius-lg] fairytale-shadow border border-border/30 overflow-hidden">
      <div className="p-5 border-b border-border/30">
        <h3 className="font-serif text-lg font-semibold text-foreground">Recent Transactions</h3>
        <p className="text-xs text-muted-foreground mt-0.5">Latest issue and return activity</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-muted/30">
              ...
              <th className="text-center px-5 py-3 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Fine</th>
            </tr>
          </thead>
          <tbody>
            {sorted?.map((tx) => (
